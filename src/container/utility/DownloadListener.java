...
/**
 * Interface for download listener. The download listener receives messages from the read loop. It is passed the progress as a percentage if known, or -1.0 to indicate indeterminate progress.
 *
 * @author Murat Artim
 * @date May 15, 2016
 * @time 3:48:14 PM
